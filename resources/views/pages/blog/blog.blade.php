...
@section('content')
        ...
        <section class="wow fadeIn cover-background background-position-top top-space" style="background-image: url(&quot;images/parallax-bg53.jpg&quot;); visibility: visible; animation-name: fadeIn;">
            <div class="opacity-medium bg-extra-dark-gray"></div>
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-12 d-flex justify-content-center flex-column text-center page-title-large padding-30px-tb">
                        <!-- start sub title -->
                        <span class="text-white-2 opacity6 alt-font margin-10px-bottom d-block text-uppercase text-small">25 April 2017&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;by <a href="blog-masonry.html" class="text-white-2">Jay Benjamin</a>&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;<a href="blog-masonry.html" class="text-white-2">Design</a>, <a href="blog-masonry.html" class="text-white-2">Branding</a></span>
                        <!-- end sub title -->
                        <!-- start page title -->
                        <h1 class="text-white-2 alt-font font-weight-600 margin-10px-bottom">Perfection is not attainable</h1>
                        <!-- end page title -->
                    </div>
                </div>
            </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-12 col-lg-10 mx-auto text-center last-paragraph-no-margin">
                        ...
                        <img src="images/blog-details-img2.jpg" alt="" class="width-100 margin-40px-tb md-margin-30px-tb" data-no-retina="">
                        <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of letraset sheets containing lorem ipsum passages, and more recently with desktop publishing software like Aldus pagemaker including versions of Lorem Ipsum.</p>
                    </div>
                    <div class="col-12 col-lg-10 mx-auto text-center last-paragraph-no-margin">
                        <img src="images/blog-details-img3.jpg" alt="" class="width-100 margin-40px-tb md-margin-30px-tb" data-no-retina="">
                    ...
                    <div class="col-12 col-lg-10 mx-auto text-center margin-60px-bottom last-paragraph-no-margin md-margin-30px-bottom">
                        <img src="images/blog-details-img4.jpg" alt="" class="width-100 margin-40px-bottom md-margin-30px-bottom" data-no-retina="">
                        <p>There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don't look even slightly believable. If you are going to use a passage of Lorem Ipsum, you need to be sure there isn't anything embarrassing hidden in the middle of text. All the Lorem Ipsum generators on the Internet tend to repeat predefined chunks as necessary, making this the first true generator on the Internet. It uses a dictionary of over 200 Latin words, combined with a handful of model sentence structures, to generate Lorem Ipsum which looks reasonable. The generated Lorem Ipsum is therefore always free from repetition, injected humour.</p>
                    </div>
                </div>
                <div class="row">
        ...
        <section class="wow fadeIn pt-0" style="visibility: visible; animation-name: fadeIn;">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-12 col-lg-10 mx-auto margin-50px-top md-margin-30px-top wow fadeInUp" style="visibility: visible; animation-name: fadeInUp;">
        ...
        <section class="wow fadeIn bg-light-gray" style="visibility: visible; animation-name: fadeIn;">
            <div class="container">
                ...
                <div class="row">
                    ...
                    <!-- end post item -->
                    <!-- start post item -->
                    <div class="col-12 col-lg-3 col-md-6 last-paragraph-no-margin md-margin-50px-bottom sm-margin-30px-bottom wow fadeInUp" data-wow-delay="0.2s" style="visibility: visible; animation-delay: 0.2s; animation-name: fadeInUp;">
                        <div class="blog-post blog-post-style1 text-center text-md-left">
                            <div class="blog-post-images overflow-hidden margin-25px-bottom md-margin-20px-bottom">
                    ...
                    <!-- end post item -->
                    <!-- start post item -->
                    <div class="col-12 col-lg-3 col-md-6 last-paragraph-no-margin sm-margin-30px-bottom wow fadeInUp" data-wow-delay="0.4s" style="visibility: visible; animation-delay: 0.4s; animation-name: fadeInUp;">
                        <div class="blog-post blog-post-style1 text-center text-md-left">
                            <div class="blog-post-images overflow-hidden margin-25px-bottom md-margin-20px-bottom">
                    ...
                    <!-- end post item -->
                    <!-- start post item -->
                    <div class="col-12 col-lg-3 col-md-6 last-paragraph-no-margin wow fadeInUp" data-wow-delay="0.6s" style="visibility: visible; animation-delay: 0.6s; animation-name: fadeInUp;">
                        <div class="blog-post blog-post-style1 text-center text-md-left">
                            <div class="blog-post-images overflow-hidden margin-25px-bottom md-margin-20px-bottom">
                    ...
                    <div class="col-12 col-lg-10 mx-auto">
                        <ul class="blog-comment">
                            <li>
                                <div class="d-block d-md-flex width-100 width-100">
                                    <div class="width-110px sm-width-50px text-center sm-margin-10px-bottom">
                                        <img src="images/avtar-02.jpg" class="rounded-circle width-85 sm-width-100" alt="" data-no-retina="">
                                    </div>
                                ...
                                <ul class="child-comment">
                                    <li>
                                        <div class="d-block d-md-flex width-100 width-100">
                                            <div class="width-110px sm-width-50px text-center sm-margin-10px-bottom">
                                                <img src="images/avtar-01.jpg" class="rounded-circle width-85 sm-width-100" alt="" data-no-retina="">
                                            </div>
                                            <div class="width-100 padding-40px-left last-paragraph-no-margin sm-no-padding-left">
                            ...
                            <li>
                                <div class="d-block d-md-flex width-100 width-100">
                                    <div class="width-110px sm-width-50px text-center sm-margin-10px-bottom">
                                        <img src="images/avtar-04.jpg" class="rounded-circle width-85 sm-width-100" alt="" data-no-retina="">
                                    </div>
                                    <div class="width-100 padding-40px-left last-paragraph-no-margin sm-no-padding-left">
        ...
        <section class="wow fadeIn bg-light-gray" id="comments" style="visibility: visible; animation-name: fadeIn;">
            <div class="container">
                <div class="row">
                    <div class="col-12 col-lg-10 mx-auto text-center margin-80px-bottom sm-margin-40px-bottom">
                        <div class="position-relative overflow-hidden width-100">
