<template>
	<div>
		...
		<section
			id="home"
			class="p-0 parallax mobile-height md-position-relative wow fadeIn"
			data-stellar-background-ratio="0.5"
			style="background-image:url('images/pofo-demo-parallax.jpg');"
		>
			...
			<div class="container position-relative full-screen">
				<div class="slider-typography">
						...
						<div class="container-fluid auth-container">
							<div id="login" class="login">
								...
								<div class="login-form">
									<div class="username-row row login-row">
                    ...
                    C-191.3,356.5-196.9,350.3-203.7,350.3L-203.7,350.3z"
									...
									<div class="password-row row login-row">
